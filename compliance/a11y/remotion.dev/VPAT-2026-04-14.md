...
- Form inputs on homepage "Newsletter", /player "Demo", and /convert "Load from URL" dialog use placeholder only — no persistent `<label>`.
...
- See 1.3.1. Placeholder-only inputs on homepage "Newsletter", /player "Demo", and /convert "Load from URL" dialog. /convert "Sample Rate" combobox label not associated.
...
| 4.1.2         | Missing names/roles/states on video controls, toggles, dialogs, iframes         | /, /blog, /contact, /docs, /convert, /player                                   |
| 4.1.3         | Status messages ("Copied", progress, spinners) not announced                     | /docs, /convert, /player, /docs/lambda/webhooks                                |
...
| 3.3.2         | Placeholder-only input labels                                                         | /, /player, /convert                                        |
