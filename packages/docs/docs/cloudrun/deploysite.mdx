...
#### `rspack?`<AvailableFrom v="4.0.TBD"/>

_default: `false`_

Whether to use [Rspack](https://rspack.dev) instead of Webpack as the bundler. See [Config.setExperimentalRspackEnabled()](/docs/config#setexperimentalrspackenabled) for more information.
