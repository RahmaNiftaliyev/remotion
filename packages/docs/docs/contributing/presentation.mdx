...
<Step>1</Step> Author the shader using <a href="/docs/transitions/make-html-in-canvas-presentation"><code>makeHtmlInCanvasPresentation()</code></a> and the <code>HtmlInCanvasShader&lt;Props&gt;</code> type. See <a href="https://github.com/remotion-dev/remotion/blob/main/packages/transitions/src/presentations/zoom-blur.tsx"><code>zoom-blur.tsx</code></a> as a reference.<br />
