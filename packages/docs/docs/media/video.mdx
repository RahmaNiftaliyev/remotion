...
For more information on HLS support, see the [HLS documentation](/docs/miscellaneous/snippets/hls).
...
### `objectFit?`<AvailableFrom v="4.0.442" />
...
- [HLS support (HTTP Live Streaming)](/docs/miscellaneous/snippets/hls)
