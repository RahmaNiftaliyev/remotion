...
The following package of Remotion are using [Mediabunny](https://mediabunny.dev):

- [`@remotion/media`](/docs/media)
- [`@remotion/media-utils`](/docs/media-utils)

The current version of Remotion uses version [`1.34.5`](https://github.com/Vanilagy/mediabunny/releases/tag/v1.34.5) of Mediabunny.
