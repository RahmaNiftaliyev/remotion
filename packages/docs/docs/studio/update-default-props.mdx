...
This function is an alias for [`saveDefaultProps()`](/docs/studio/save-default-props).

:::info
Before v4.0.437, this function only updated the props in the Props Editor without saving them to the root file. Starting from v4.0.437, it also saves the props to the root file.
:::
