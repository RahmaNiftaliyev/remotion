...
<Step>1</Step> The current <code>presentationProgress</code>, influenced by the timing of the transition<br />
<Step>2</Step> The <code>presentationDirection</code>, either <code>entering</code> or <code>exiting</code><br />
<Step>3</Step> The <code>presentationDurationInFrames</code> (_available from v4.0.153_)<br/>
