---
image: /generated/articles-docs-transitions-presentations-iris.png
...
```tsx twoslash title="IrisTransition.tsx"
...
<CompatibilityTable hideBrowsers hideServers clientSideRendering serverSideRendering player studio />
