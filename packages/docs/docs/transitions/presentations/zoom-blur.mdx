...
:::warning
This presentation is built on top of the experimental [HTML-in-canvas](/docs/client-side-rendering/html-in-canvas) feature and currently requires [Chrome Canary](https://www.google.com/chrome/canary/) with `chrome://flags/#canvas-draw-element` enabled. It does not work in Firefox or Safari, and it cannot be rendered server-side.
:::
