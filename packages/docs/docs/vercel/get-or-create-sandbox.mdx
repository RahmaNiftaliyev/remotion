...
# getOrCreateSandbox()<AvailableFrom v="4.0.425" />
...
// @module: es2022
// @target: es2022
import {getOrCreateSandbox} from '@remotion/vercel';
// ---cut---
...
A callback of type [`CreateSandboxOnProgress`](/docs/vercel/create-sandbox#onprogress) that receives progress updates. Only called during development when a fresh sandbox is created.
