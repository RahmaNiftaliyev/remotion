...
_function_ <TsType type="RenderMediaOnProgress" source="@remotion/renderer" href="/docs/renderer/render-media#onprogress" />

Same callback as [`renderMedia()`](/docs/renderer/render-media#onprogress). Receives render progress updates.

```ts twoslash
import type {RenderMediaOnProgress} from '@remotion/vercel';
// ---cut---
