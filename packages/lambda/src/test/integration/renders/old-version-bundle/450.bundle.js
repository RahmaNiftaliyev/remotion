(this["webpackChunk_remotion_example"] = this["webpackChunk_remotion_example"] || []).push([[450],{
...
/* harmony export */ });
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4783);
...
/* harmony import */ var _remotion_gif__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5129);
/* harmony import */ var _remotion_gif__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_remotion_gif__WEBPACK_IMPORTED_MODULE_1__);


const GifTest = () => {
  const { width, height } = (0,remotion__WEBPACK_IMPORTED_MODULE_0__.useVideoConfig)();
  return /* @__PURE__ */ React.createElement("div", {
    style: { flex: 1, backgroundColor: "black" }
  }, /* @__PURE__ */ React.createElement(remotion__WEBPACK_IMPORTED_MODULE_0__.Sequence, {
    from: 0,
    durationInFrames: 50
  }, /* @__PURE__ */ React.createElement(_remotion_gif__WEBPACK_IMPORTED_MODULE_1__.Gif, {
...
const Gif = (props) => {
  if (remotion_1.Internals.getRemotionEnvironment() === "rendering") {
    return (0, jsx_runtime_1.jsx)(GifForRendering_1.GifForRendering, Object.assign({}, props), void 0);
  }
  return (0, jsx_runtime_1.jsx)(GifForDevelopment_1.GifForDevelopment, Object.assign({}, props), void 0);
};
exports.Gif = Gif;
...
exports.GifForDevelopment = (0, react_1.forwardRef)((_a, ref) => {
  var _b = _a, { src, width, height, onError, onLoad, fit = "fill" } = _b, props = __objRest(_b, ["src", "width", "height", "onError", "onLoad", "fit"]);
  ...
  return (0, jsx_runtime_1.jsx)(tools_1.Canvas, Object.assign({ fit, index, frames: state.frames, width: width !== null && width !== void 0 ? width : state.width, height: height !== null && height !== void 0 ? height : state.height }, props, { ref }), void 0);
});
...
exports.GifForRendering = (0, react_1.forwardRef)((_a, ref) => {
  var _b = _a, { src, width, height, onLoad, onError, fit = "fill" } = _b, props = __objRest(_b, ["src", "width", "height", "onLoad", "onError", "fit"]);
  const [state, update] = (0, react_1.useState)({
    delays: [],
    frames: [],
    width: 0,
...
function useCurrentGifIndex(delays) {
  ...
  const index = (0, react_1.useMemo)(() => {
    if (videoConfig && delays.length !== 0) {
      let currentTime = currentFrame / videoConfig.fps * 1e3 % duration;
...
/* harmony export */   "useWorkerParser": () => (/* binding */ useWorkerParser)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2386);
/* harmony import */ var gifuct_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1258);
...
const usePlayerState = stateOrFn => {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useReducer)(reducer, stateOrFn, initializer);
};
...
}).then(buffer => (0,gifuct_js__WEBPACK_IMPORTED_MODULE_1__/* .parseGIF */ .vq)(buffer)).then(gif => {
  validateAndFix(gif);
  return gif;
}).then(gif => Promise.all([(0,gifuct_js__WEBPACK_IMPORTED_MODULE_1__/* .decompressFrames */ .zw)(gif, false), {
  width: gif.lsd.width,
...
const useEventCallback = callback => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(arg => ref.current && ref.current(arg), []);
};
...
const Canvas = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function Canvas({
  index,
  frames,
  width,
  height,
