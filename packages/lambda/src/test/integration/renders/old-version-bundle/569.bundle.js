"use strict";
(this["webpackChunk_remotion_example"] = this["webpackChunk_remotion_example"] || []).push([[569],{
...
const Circle = ({ size }) => {
  ...
  const angle = (0,dist.interpolate)(progress, [0, 1], [0, Math.PI * 2]);
  const squircleFactor = (0,dist.interpolate)(progress, [0, 1], [0.5, 1.05]);
  ...
  const color = (0,polished_esm/* mix */.CD)(shade * 0.1, "#000", "#fff");
