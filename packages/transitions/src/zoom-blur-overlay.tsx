...
type Props = {
	readonly prevImageRef: RefObject<ElementImage | null>;
	readonly nextImageRef: RefObject<ElementImage | null>;
};

export const ZoomBlurOverlay: React.FC<Props> = ({
	prevImageRef,
	nextImageRef,
}) => {
